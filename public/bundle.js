...
var _messenger = __webpack_require__(25);
...
function addEventListenersToDocument() {
  ...
  (0, _jquery2.default)('#formChat').submit(function () {
    chat();
    return false;
  });

  (0, _jquery2.default)('#formLogin').submit(function () {
    login();
    return false;
  });
}
...
function chat() {
  ...
  socket.emit('chat message', (0, _jquery2.default)('#inputMessage').val());
