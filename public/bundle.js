...
var Messenger = function () {
  ...
  _createClass(Messenger, [{
    ...
    value: function appendMyMessage(user, msg) {
      this.$messages.append((0, _jquery2.default)('<li>').html('<span class="label label-success">' + user + '</span> ' + msg));
      this._scrollDown();
    }
  }, {
    key: 'appendYourMessage',
    value: function appendYourMessage(user, msg) {
      this.$messages.append((0, _jquery2.default)('<li>').html('<span class="label label-default">' + user + '</span> ' + msg));
      this._scrollDown();
    }
  }, {
    ...
    value: function removeTyping(user) {
      ...
      msgToRemove.fadeOut(function () {
        (0, _jquery2.default)(msgToRemove).remove();
      });
    }
  }, {
    key: '_getTypingMessages',
    value: function _getTypingMessages(user) {
      return (0, _jquery2.default)('.log').filter(function (index, element) {
        return (0, _jquery2.default)(element).data('user') === user;
      });
    }
  }, {
    key: '_scrollDown',
...
;(function () {
  ...
  var isLoader = "function" === "function" && __webpack_require__(55);
...
var _messenger = __webpack_require__(26);
...
function login() {
  ...
  if (username) {
    socket.emit('add user', username, function (okay) {
      if (okay) {
        (0, _jquery2.default)('#loginPage').fadeOut();
...
(0, _jquery2.default)(function () {
  messenger = new _messenger2.default((0, _jquery2.default)('#messages'));
...
function addEventListenersToSocket() {
  ...
  socket.on('users', function (users) {
    ...
    (0, _jquery2.default)('#users').html(html);
  });
...
function addEventListenersToDocument() {
  var $input = (0, _jquery2.default)('#inputMessage');
  $input.on('input', function (e) {
    monitorTyping();
  });

  (0, _jquery2.default)('#formChat').submit(function (e) {
    e.preventDefault();
    sendMessage();
  });

  (0, _jquery2.default)('#formLogin').submit(function (e) {
    e.preventDefault();
    login();
  });
}
